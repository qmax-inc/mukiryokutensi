...
(function() {
  ...
  Game_Map.prototype.setupForeground = function() {
    if ($dataMap.meta) {
      ...
      this._foregroundBlendMode = $dataMap.meta.fgBlendMode || 'NORMAL';
    }
    this._foregroundX = 0;
    this._foregroundY = 0;
  };
  ...
  Spriteset_Map.prototype.createForeground = function() {
    ...
    this._foreground.blendMode = PIXI.BLEND_MODES[$gameMap._foregroundBlendMode];
